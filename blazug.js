/* blazug@2.2.0 | (c) Qwot | https://github.com/QwotApp/TestBedBlazug/blob/main/LICENSE */
...
(function (blazug) {
  ...
  const getVersion = () => "blazug@2.2.0".replace("blazug@",""); // for easy versioning increment.
  ...
  const initBlazugUI = (controlId, value, minsize) => {
    ...
    let startUpAttributValue = "";

    if(startUpAttribut!= null) {
      startUpAttributValue = startUpAttribut.toLowerCase();
      if(startUpAttributValue!= "hidden" && startUpAttributValue!= "normal" && startUpAttributValue!= "controls" && startUpAttributValue!= "console"){
        startUpAttributValue = "";
      }
    } 

    startUpAttributValue = startUpAttributValue == "" ? "normal" : startUpAttributValue;

    blazug.display(startUpAttributValue);
