/* blazug@2.2.2 | (c) Qwot | https://github.com/QwotApp/TestBedBlazug/blob/main/LICENSE */
...
(function (blazug) {
  ...
  const getVersion = () => "blazug@2.2.2".replace("blazug@",""); // for easy versioning increment.
