/* blazug@2.1.7 | (c) Qwot | https://github.com/QwotApp/TestBedBlazug/blob/main/LICENSE */
...
(function (blazug) {
  ...
  const getVersion = () => "blazug@2.1.7".replace("blazug@",""); // for easy versioning increment.
