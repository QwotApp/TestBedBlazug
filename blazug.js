/* blazug@2.2.3 | (c) Qwot | https://github.com/QwotApp/TestBedBlazug/blob/main/LICENSE */
...
(function (blazug) {
  ...
  const getVersion = () => "blazug@2.2.3".replace("blazug@",""); // for easy versioning increment.
